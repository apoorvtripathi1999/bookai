# Modified: Removed texttospeech_v1 import
from datetime import datetime
from flask import Flask, render_template, request, redirect, url_for, send_file, send_from_directory
from werkzeug.utils import secure_filename
import os

# Modified: Replaced speech import with Vertex AI Speech-to-Text v2
from google.cloud.speech_v2 import SpeechClient
from google.cloud.speech_v2.types import cloud_speech
# Modified: Replaced language import with Vertex AI Natural Language API v2
...
# Modified: Using Vertex AI Speech-to-Text client with proper endpoint
sr_client = SpeechClient(client_options={"api_endpoint": "us-central1-speech.googleapis.com"})
# Modified: Using Vertex AI Natural Language client
...
def sample_recognize(content):
    # Modified: Using Vertex AI Speech-to-Text v2 for transcription
    ...
    project_id = os.environ.get("GOOGLE_CLOUD_PROJECT", "project-2-convoai")
    recognizer = f"projects/{project-2-convoai}/locations/us-central1/recognizers/_"
...
def analyze_sentiment(text):
    # Modified: Using Vertex AI Natural Language API v2 for sentiment analysis
    document = Document(
        content=text,
